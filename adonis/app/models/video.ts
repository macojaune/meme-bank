...
import { BaseModel, column, hasOne, hasMany, manyToMany, beforeCreate } from '@adonisjs/lucid/orm'
...
import type { HasOne, ManyToMany, HasMany } from '@adonisjs/lucid/types/relations'
